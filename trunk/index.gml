...
Click the tabs to view an inventory of associations in Pearl River County.
    </gm:section>          
                
    <gm:section id="sectionCivicOrganizations" title="Civic Organizations">
<div>
...
<gm:list id="listCivicOrganizations" data="http://spreadsheets.google.com/feeds/list/o17634829598942266075.7826875436890504248/ocx/public/values?sq=civicorganization%3D1" pagesize="10" template="myListTemplate">
<gm:handleEvent event="select" src="mapCivicOrganizations"/>
</gm:list>
</td>
<td valign="top">
<gm:map id="mapCivicOrganizations" style="border:solid black 1px" control="large"
maptypes="true" data="${listCivicOrganizations}" latref="gsx:bglat" lngref="gsx:bglong"
infotemplate="myMapDetailsTemplate"
lat="30.53" lng="-89.68" zoom="8">
<gm:handleEvent event="select" src="listCivicOrganizations"/>
</gm:map>
</td>
</tr>
</table>
...
<iframe width='100%' height='100%' frameborder='0' src='http://spreadsheets.google.com/pub?key=p24J_PxaAu_Q4vBbFvaWebA&gid=11'></iframe>
</gm:section> 
